...
Public Class NewsQuery
    Inherits FileQuery
    Private Q_Select As String = "Select T_NEWS.ID, C_CREATIONDATE, C_NAME, C_CLASSID, C_LASTMODIFIER, C_BODY, C_TAGGED, C_Description, C_CATEGORY"
            ...
            Using connection As New SqlConnection(connectionString)
                Using command As SqlCommand = New SqlCommand(Query, connection)
                    ...
                    Do While reader.Read()
                        ...
                        Me.C_Category = reader.GetString(8)
                        record = Me.ToString()
                        result.Add(record)
                    Loop
