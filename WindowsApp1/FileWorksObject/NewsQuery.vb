...
Public Class NewsQuery
    ...
    Public Overrides Function Run() As List(Of String)
        ...
        Try
            ...
            Do While reader.Read()
                ...
                Me.Category.ColumnValue = reader.GetString(7)
                record = Me.ToString()
                result.Add(record)
            Loop
    ...
    Public Overrides Function ToString() As String
        Dim Info As String = $"^_^{Me.Category.ColumnValue}"
        Return MyBase.ToString() & Info
    End Function

    Public Property Category As New ColumnInformation(Of String) With {.ColumnName = "C_Category", .SelectFlag = True}
