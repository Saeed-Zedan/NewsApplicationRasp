...
Public Class FileService
    'Private apiUrl = "https://localhost:44317/api/File"
    Private controllerName As String = "File"
    ...
    Public Function Update(obj As FileWorksObject.File) As String
        ...
        Dim result = objService.Update(Of FileWorksObject.File)(obj)
    ...
    Public Function Run(obj As FileQuery) As JArray
        ...
        Dim result = objService.Run(Of FileQuery)(obj)
