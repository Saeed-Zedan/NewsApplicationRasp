...
Public Class UserService
    ...
    Private controllerName As String = "User"
    ...
    Public Function Update(obj As FileWorksObject.User) As String
        ...
        Dim result = objService.Update(Of User)(obj)
    ...
    Public Function Run(obj As UserQuery) As JArray
        ...
        Dim result = objService.Run(Of UserQuery)(obj)
