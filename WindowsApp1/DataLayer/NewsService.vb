...
Public Class NewsService
    ...
    Private controllerName As String = "News"
    ...
    Public Function Update(obj As News) As String
        ...
        Dim result = objService.Update(Of News)(obj)
    ...
    Public Function Run(obj As NewsQuery) As JArray
        ...
        Dim result = objService.Run(Of NewsQuery)(obj)
